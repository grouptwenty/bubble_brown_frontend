...
${GotoEntrepreneurManagement}  http://192.168.0.176:3000/#/entrepreneur 
${Browser}  chrome
${Result}  False
...
GotoMyEntrepreneur
    Go To  ${GotoEntrepreneurManagement} 
    Click Button  add_entrepreneur

FormEntrepreneur
    [Arguments]  ${entrepreneur_name_th}  ${entrepreneur_name_en}  ${entrepreneur_tel}  ${entrepreneur_email}  ${entrepreneur_username}  ${entrepreneur_password}  ${entrepreneur_address}  ${path_upload} 
