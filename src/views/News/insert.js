...
class insertView extends Component {
    ...
    async componentDidMount() {
        const max_code = await news_model.getNewsMaxCode()
        console.log("max_code", max_code);

        document.getElementById("news_code").value = 'NW' + max_code.data.news_code_max
    ...
    async handleSubmit(event) {
        ...
        if (this.check(arr)) {
            var res = await news_model.insertNewsBy(arr);
            //   console.log(res)
            if (res.data) {
                swal({
                    title: "Good job!",
                    ...
                    <Col>
                        <Card>
                            <Form onSubmit={this.handleSubmit} id="myForm">
                                <CardHeader>
                                    เพิ่มข้อมูลข่าวสาร/  Insert News
                                        ...
                                        <Col lg="8">
                                            ...
                                            <Row>
                                                <Col lg="6">
                                                    ...
                                                    <textarea type="text" id="news_title" name="news_title" class="form-control" style={{ height: 150 }} ></textarea>
                                                </Col>
                                                <Col lg="6">
                                                    <Label className="text_head"> บทคัดย่อ<font color='red'><b> * </b></font></Label>
                                                    <textarea type="text" id="news_description" name="news_description" class="form-control" style={{ height: 150 }} ></textarea>
                                                </Col>
